...
final readonly class XmlRenderer
{
    ...
    private function formatFailure(DOMDocument $dom, TestResult $result): DOMElement
    {
        ...
        $failure->appendChild($this->createElement($dom, 'expected_valid', $result->expected ? 'true' : 'false'));
        $failure->appendChild($this->createElement($dom, 'actual_valid', $result->actual ? 'true' : 'false'));
