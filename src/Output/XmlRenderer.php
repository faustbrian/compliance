...
final readonly class XmlRenderer
{
    ...
    private function formatFailure(DOMDocument $dom, TestResult $result): DOMElement
    {
        ...
        $failure->appendChild($this->createElement($dom, 'expected_valid', $result->expectedValid ? 'true' : 'false'));
        $failure->appendChild($this->createElement($dom, 'actual_valid', $result->actualValid ? 'true' : 'false'));
