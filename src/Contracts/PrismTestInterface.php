...
/**
 * Contract for prism test implementations.
 *
 * Defines the interface for running prism validation tests against
...
interface PrismTestInterface
{
     ...
     *
     * Returns the file system path where prism test JSON files are stored
